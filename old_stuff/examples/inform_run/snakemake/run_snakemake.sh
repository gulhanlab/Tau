...
snakemake all --use-conda --executor slurm --default-resources slurm_account=park_contrib slurm_partition=park runtime=14400 --jobs 300 --rerun-triggers mtime --retries 3 --rerun-incomplete
