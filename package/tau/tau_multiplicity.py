...
class Segment:
    ...
    # ----------------------------------------------------------
    # EM estimation and fixed-ESS bootstrap
    # ----------------------------------------------------------
...
# Segment
Segment.time_segment = tau_time._segment_time_segment

# Genome
Genome.time_segments = tau_time._genome_time_segments
Genome.times_to_df = tau_time._genome_times_to_df
Genome.summarize_discards = tau_time._genome_summarize_discards
Genome.summarize_constraint_violations = tau_time._genome_summarize_constraint_violations
